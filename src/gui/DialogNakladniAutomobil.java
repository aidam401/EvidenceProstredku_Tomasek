 ...
 * @author Adam_Tomasek
 */
public class DialogNakladniAutomobil extends DialogDopravniProstredek{
    ...
    public Optional<DopravniProstredek> vratNovyNakladniAutomobil() {

        super.DIALOG.setResultConverter((button) -> {
            if (button == ButtonType.OK) {
                return new NakladniAutomobil(super.spz.getText(),
